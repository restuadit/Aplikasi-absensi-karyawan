       ...
       <div class="offcanvas-body">
         <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" style="font-family: Arial, Helvetica, sans-serif">
           <li class="nav-item my-2">
             <a class="nav-link rounded-3 " aria-current="page" href="/home" style="border: 1px solid white;">&nbsp;<img src="<?php echo e(asset('icon/house.svg')); ?>"> Home</a>
           </li>
           <?php if(auth()->user()->level=='admin'): ?>
              <li class="nav-item my-2">
               <a class="nav-link  rounded-3" href="/karyawan" style="border: 1px solid white">&nbsp;<img src="<?php echo e(asset('icon/bar-chart.svg')); ?>"> Data Karyawan</a>
              </li>
              <li class="nav-item my-2">
                  <a class="nav-link rounded-3" href="/absen/karyawan" style="border: 1px solid white">&nbsp;<img src="<?php echo e(asset('icon/clipboard-data.svg')); ?>"> Absenan Karyawan</a>
              </li>
           <?php endif; ?>
           <?php if(auth()->user()->level=='user'): ?>
              <li class="nav-item my-2">
               <a class="nav-link rounded-3" href="/profil/<?php echo e(auth()->user()->id); ?>" style="border: 1px solid white">&nbsp;<img src="<?php echo e(asset('icon/person.svg')); ?>"> Profil</a>
              </li>
               <li class="nav-item my-2" >
                  <a class="nav-link rounded-3" href="/absen/user/<?php echo e(auth()->user()->id); ?>" style="border: 1px solid white">&nbsp;<img src="<?php echo e(asset('icon/person-video2.svg')); ?>"> Absen Harian</a>
                </li>
           <?php endif; ?>
            ...
            <li class="nav-item my-2">
               <a class="nav-link rounded-3" href="/logout" style="border: 1px solid white">&nbsp;<img src="<?php echo e(asset('icon/box-arrow-left.svg')); ?>"> Logout</a>
            </li>
         </ul>
...
</body><?php /**PATH C:\xampp\htdocs\coba-laravel\coba-project\resources\views/template.blade.php ENDPATH**/ ?>