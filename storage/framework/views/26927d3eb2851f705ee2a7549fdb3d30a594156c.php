...
<?php $__env->startSection('konten'); ?>
   ...
   <form class="row g-3 px-5 text-primary" method="POST" action="/karyawan/edit/prosesedit/<?php echo e($id); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="col-12">
         <label for="inputAddress" class="form-label">Nama</label>
         <input type="text" class="form-control" id="inputAddress" name="nama" value="<?php echo e($name); ?>">
       </div>
      <div class="col-md-6">
        <label for="inputEmail4" class="form-label">Email</label>
        <input type="email" class="form-control" id="inputEmail4" name="email" value="<?php echo e($email); ?>">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-12 mt-2">
        ...
        <input type="number" class="form-control" id="inputAddress" placeholder="" name="no_telp" value="<?php echo e($no_telp); ?>">
      </div>
      <div class="col-12">
        <label for="inputAddress2" class="form-label">Alamat</label>
        <input type="text" class="form-control" id="inputAddress2" placeholder="" name="alamat" value="<?php echo e($alamat); ?>">
      </div>
      <div class="mt-4 ms-2 p-2 border rounded" style="height:140px; width:110px;">
        <img src="<?php echo e(asset('storage/'. $image)); ?>" style="height:120px; width:90px;">
      </div>
      <div class="mb-3">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coba-laravel\coba-project\resources\views/editkaryawan.blade.php ENDPATH**/ ?>